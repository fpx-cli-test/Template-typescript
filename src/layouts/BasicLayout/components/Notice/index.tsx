...
const defaultNoticeList: INotcieItem[] = [
  {
    ...
    message: '新标识怎么去掉？', //Panda comment:"新标识怎么去掉？" 与 文案 "新标识怎么去掉" 共用key:HowToRemoveTheNewLogo.four_px，请注意补全文案前后自带符号
  },
  {
    id: 2,
    name: 'Mark',
    avatar: 'https://img.alicdn.com/tfs/TB1.ZBecq67gK0jSZFHXXa9jVXa-904-826.png',
    message: '如何查看新增页面？', //Panda comment:"如何查看新增页面？" 与 文案 "如何查看新增页面" 共用key:HowToViewNewPages.four_px，请注意补全文案前后自带符号
  },
];
